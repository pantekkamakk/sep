...
options = {
    'proxy': {
        'http': 'http://sodagar:FGAMRHJ-QQHC7SJ-0RPJ3H1-BOMNLIP-WKACAQO-GWSCKMZ-SET2MG4@unmetered.residential.proxyrack.net:10081',
        'https': 'https://sodagar:FGAMRHJ-QQHC7SJ-0RPJ3H1-BOMNLIP-WKACAQO-GWSCKMZ-SET2MG4@unmetered.residential.proxyrack.net:10081',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/ab5df46f-cad6-4b06-be75-ada0faf6a421")
time.sleep(50000)
