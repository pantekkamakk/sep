...
options = {
    'proxy': {
        'http': 'http://sodagar:FGAMRHJ-QQHC7SJ-0RPJ3H1-BOMNLIP-WKACAQO-GWSCKMZ-SET2MG4@unmetered.residential.proxyrack.net:10073',
        'https': 'https://sodagar:FGAMRHJ-QQHC7SJ-0RPJ3H1-BOMNLIP-WKACAQO-GWSCKMZ-SET2MG4@unmetered.residential.proxyrack.net:10073',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/d54ecc77-78a8-481e-99ea-66618ed58d44")
time.sleep(50000)
